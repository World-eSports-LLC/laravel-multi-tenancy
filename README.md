...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/world-esports-llc/multi-tenancy/run-tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/worldesports/laravel-auto-tenancy/actions?query=workflow%3Arun-tests+branch%3Amain)
